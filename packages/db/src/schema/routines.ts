...
import type { RoutineEnvConfig, RoutineIssueTemplate, RoutineRevisionSnapshotV1, RoutineVariable } from "@paperclipai/shared";
...
export const routines = pgTable(
  "routines",
  {
    ...
    issueTemplate: jsonb("issue_template").$type<RoutineIssueTemplate | null>(),
